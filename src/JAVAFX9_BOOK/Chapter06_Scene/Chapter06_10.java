...
public class Chapter06_10 extends Application {
        ...
        try {
            ...
            scene.getAccelerators().put(kk, () -> {
                Callback<SnapshotResult, Void> c = (sr) -> {
                    File file = new File("/home/wojciech/IdeaProjects/JavaFxExercises/src/JAVAFX9_BOOK/Chapter06_Scene/ryc06_05.png");
                ...
                WritableImage w = new WritableImage(300, 100);
                scene.snapshot(c, w);
            });
