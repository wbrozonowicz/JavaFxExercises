...
// odczyt danych o pzycji kursora w momencie kilkniecia
public class Chapter05_20 extends Application {
    ...
    public void start(Stage stage) {
        try {
            Label label = new Label("Naciśnij przycisk myszy nad kwadratem");
