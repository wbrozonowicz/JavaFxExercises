...
// zdarzenia myszy - przesuwanie bez naciskania
public class Chapter05_14 extends Application {
    ...
    public void start(Stage stage) {
        try {
            Label label = new Label(
                    "Przesuń mysz nad kwadratem bez naciskania przycisków");
            ...
            rect.addEventHandler(MouseEvent.MOUSE_MOVED, mouseHandler);
