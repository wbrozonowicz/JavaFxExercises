...
// konsumpcja zdarzenia (przerwanie łąńcucha zdarzeń) na etapie filtrowania (w pierwszej fazie, obsługiwanej przez filtry)
public class Chapter05_04 extends Application {
    ...
    public void start(Stage stage) {
        try {
            ...
            EventHandler<MouseEvent> mouseFilter1 = e -> {
                System.out.print("Filter: ");
                e.consume();  // wywołanie metody konsumuj
                IPrint.printShort(e);
            };
            stage.addEventFilter(MouseEvent.MOUSE_CLICKED, mouseFilter);
            scene.addEventFilter(MouseEvent.MOUSE_CLICKED, mouseFilter1);
