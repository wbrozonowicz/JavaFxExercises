...
//zmiana współrzędnych względem punktu 0,0 węzła rodzicielskiego
public class Chapter07_04 extends Application {
    ...
    public void start(Stage stage) {
        try {
            ...
            root1.getChildren().addAll(circle1, rect, line1, line2, line5, line6,
                    t1, t2);
            Pane root2 = new Pane();
            ...
            root2.setLayoutX(220); //zmiana współrzędnych względem punktu 0,0 węzła rodzicielskiego
            root2.setLayoutY(0);
